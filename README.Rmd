...
I rendered the exploded .Rmd outside this file, because if felt to mind-bendy to do here.  The resultant flipbook (.html) is hosted on github, and we want to include it.
